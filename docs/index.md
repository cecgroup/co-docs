# 快速开始
## 简介
&emsp;&emsp;工一云电脑是涛勰科技基于自主研发底座和微软桌面，通过多年的探索专研与最佳实践，积淀研发的一整套云教学、云办公的解决方案。支持包含各种电脑、手机、平板、单片机、零瘦客户机等全终端设备，同时支持APP、浏览器、订阅、IE浏览器等多种方式进行访问。

## 设备-系统支持的访问方式及推荐的访问方式顺序
